...
#if defined _WIN32
    //cout << "x: " << display->x_root() << " Y: " << display->y_root() << endl;
    BOOL result = SetCursorPos(250 +  display->x_root(), 250 + display->y_root());
#endif
    //warpMouse(250 + display->x(), 250 + display->y());
    renderer.initGL(500, 500, display->x_root(), display->y_root());
