...
class TriangleGroup {
	public:
		...
		bool intersects(const Ray3 &ray, const Mesh &parent) const;
		double intersection(const Ray3 &ray, const Mesh &parent) const;
		Collision collision(const Ray3 &ray, const Mesh &parent) const;
};
